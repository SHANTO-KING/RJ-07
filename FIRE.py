...
for generate in range(10):
	...
	uaku=f'Mozilla/5.0 (Linux; U; Android {a}.{b}; Redmi 4A {b}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36 XiaoMi/Mint Browser/1.3.3'
def uaku():
	try:
